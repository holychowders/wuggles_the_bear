-- Friendly note: Leave the code better than you found it. If something looks dirty, take a minute and make it look nice
-- If you must push without working code, make sure it's commented out and you've detailed the problem
...
return {
        ...
        --PLAYER =
        --{
        --    GENERIC = "Many grr's to you, %s.",
        --    ATTACKER = "%s looks shifty...",
        --    MURDERER = "You were a fool to mess with *this* bear!",
        --    GHOST = "Grr!!! Oh, it's just %s.",
        --    REVIVER = "%s, friend of bears.",
        --    FIRESTARTER = "Grr!?",
        --},
        ...
        --WATHGRITHR =
        --{
        --    GENERIC = "A fellow warrior.",
        --    ATTACKER = "It's curtains for you, %s!!!",
        --    MURDERER = "You killed my nums!!",
        --    GHOST = "Warrior ghost!",
        --    REVIVER = "A fellow warrior comes to the rescue!",
        --    FIRESTARTER = "Grr... Wuggles doesn't like fire!",
        --},

        ---- Trees
        EVERGREEN =
        {
            GENERIC = "Nature's greatest friend!",
            CHOPPED = "Poor little tree.",
            BURNING = "It's on fire!",
            BURNT = "Gone in a puff of smoke...",
        },
        ...
        TWIGGYTREE =
        {
            GENERIC = "That'd make some great back scratchers.",
            CHOPPED = "Aww. No more twiggy.",
            BURNING = "Grr! It's on fire!",
            BURNT = "Gone in a puff of smoke...",
        },
        ...
        ---- Combat
        -- I don't know why BATTLECRY isn't working. Is this only for wathgrithr?
        --BATTLECRY =
        --{
        --    GENERIC = "Grrrrr!!!",
        --    PIG = "Num, num, num! Here, little piggy!!!",
        --    PREY = "I will maul you!",
        --    SPIDER = "Spiders!!!",
        --    SPIDER_WARRIOR = "Warrior spiders!!!",
        --    DEER = "Grrr!",
        --},
        ...
        RABBIT =
        {
            GENERIC = "A tasty rabbit.",
            HELD = "Hello, there. Have you ever been eaten?",
        },
        RABBITHOLE =
        {
            GENERIC = "Grr... That leads to bigger bunnies.",
	...
	--
        ...
        -- I've tried examining smoldering objects (evergreen, lumpy evergreen, sapling, grass tuft)
        -- ...but I get the generic examination string for each item
        --DESCRIBE_SMOLDERING = "That thing is about to catch fire.",

        -- Doesn't work. IDK why.
        --ANNOUNCE_ENTER_DARK = "Oh no! It's dark!",
        -- Doesn't work. IDK why.
        --ANNOUNCE_ENTER_LIGHT = "I'm saved by the light!",

        RESURRECTIONSTONE = "It gives life.",
        SCULPTURE_ROOKNOSE = "Grr?",

        MOLE =
        {
            HELD = "I caught you, little cretin!",
            UNDERGROUND = "Something's under there searching for minerals.",
            ABOVEGROUND = "Keep that thing away from my valuables!",
        },

        MOUND =
        {
            DUG = "It's empty now.",
            GENERIC = "Spooky... I wonder what goodies they've left behind.",
        },
        ...
        SPIDER =
        {
            DEAD = "Ewwww!",
            GENERIC = "Ewwww!",
            SLEEPING = "Grr! I'd better not be here when it wakes up!",
        },

        DIRTPILE = "*Sniff*, *Sniff*. NUMS! Follow the trail!",
}
...
--        WATHGRITHR =
--        {
--            GENERIC = "Fellow warrior, %s!",
--            ATTACKER = "It's curtains for you, %s!!!",
--            MURDERER = "You killed my nums!!",
--            --MURDERER = "You never mess with a fellow warrior.",
--            REVIVER = "A fellow warrior comes to the rescue!",
--            GHOST = "Warrior ghost!",
--            FIRESTARTER = "Grr... Wuggles doesn't like fire!",
--        },
